...
/**
 * F6/Q2=A：非 Administrator 僅保留「基本資料」Tab，
 * 隱藏「自動填入」（billing/shipping）與「其他欄位」（user_meta）兩個敏感 Tab。
 */
const visibleItems: TabsProps['items'] = IS_ADMIN
	? items
	: items?.filter((item) => item?.key === 'Basic')
